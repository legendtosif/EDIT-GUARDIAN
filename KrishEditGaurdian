...
buttons = [
    [
        InlineKeyboardButton(
            ...
            url=f"https://t.me/GroupsEditGuardian_bot?startgroup=true",
        ),
    ],
    [
        InlineKeyboardButton(text="𝗦𝘂𝗽𝗽𝗼𝗿𝘁", url=f"https://t.me/krishnetwork"),
        InlineKeyboardButton(text="𝗦𝗼𝘂𝗿𝗰𝗲", url=f"https://t.me/krishsupport"),
    ],    
    [
        InlineKeyboardButton(text="𝗢𝘄𝗻𝗲𝗿", url=f"https://t.me/ily16k"),
    ],
